...
for path in ['README.md','RELEASE_NOTES.md']:
    ...
    assert 'v0.3.1' in text and 'prerelease' in text
...
assert 'name: GBAWriter-v0.3.1' in (root/'.github/workflows/build-rom.yml').read_text()
print('PASS: v0.3.1 controls/help and hardware-unverified prerelease documentation')
